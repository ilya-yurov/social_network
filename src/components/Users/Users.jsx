...
const Users = (props) => {
	...
	let getUsersElements = () => 
	{
		...
		return (<User onFollow={props.follow} onUnFollow={props.unfollow} avatar={u.photos.small != null ? u.photos.small : userPhoto} id={u.id} follow={u.follow} userName={u.name} status={u.status} key={u.id} />)
	});
		return userElements;
	}
